...
**1928 valeurs vérifiées et datées**, 144 encore ouvertes. **9 rôles.**
...
| `references/comptabilite-generale.md` | **PARTIEL** |
...
|---|---|
| `SKILL.md` | **RÉDIGÉ** |
| `data/parametres.json` | **315 vérifiée(s)**, 18 à vérifier |
| `references/actions-rsu-bspce.md` | **PARTIEL** |
| `references/assurance-vie.md` | **RÉDIGÉ** |
| `references/declaration-annuelle.md` | **RÉDIGÉ** |
| `references/epargne-retraite-per.md` | **RÉDIGÉ** |
| `references/hauts-revenus-cehr-cdhr.md` | **PARTIEL** |
...
|---|---|
| `SKILL.md` | **RÉDIGÉ** |
| `data/parametres.json` | **275 vérifiée(s)**, 23 à vérifier |
| `references/arnaques-financieres.md` | **RÉDIGÉ** |
| `references/enveloppes-et-supports.md` | **RÉDIGÉ** |
| `references/epargne-reglementee-et-bancaire.md` | **PARTIEL** |
| `references/frais-et-performance.md` | **PARTIEL** |
| `references/gerer-son-argent.md` | **PARTIEL** |
| `references/immobilier-et-financier.md` | **PARTIEL** |
| `references/notions-financieres.md` | **RÉDIGÉ** |
| `references/retraite-et-long-terme.md` | **PARTIEL** |
| `references/risque-et-horizon.md` | **RÉDIGÉ** |
...
|---|---|
| `SKILL.md` | **RÉDIGÉ** |
| `data/parametres.json` | **274 vérifiée(s)**, 10 à vérifier |
| `references/couple.md` | **RÉDIGÉ** |
| `references/donation.md` | **RÉDIGÉ** |
| `references/enfants.md` | **PARTIEL** |
| `references/protection-des-majeurs.md` | **RÉDIGÉ** |
| `references/separation-et-divorce.md` | **PARTIEL** |
| `references/succession.md` | **PARTIEL** |
...
|---|---|
| `SKILL.md` | **RÉDIGÉ** |
| `data/parametres.json` | **80 vérifiée(s)**, 8 à vérifier |
| `references/changement-de-statut.md` | **RÉDIGÉ** |
| `references/demande-et-renouvellement.md` | **RÉDIGÉ** |
| `references/documents-etat-civil.md` | **PARTIEL** |
...
|---|---|
| `SKILL.md` | **RÉDIGÉ** |
| `data/parametres.json` | **293 vérifiée(s)**, 30 à vérifier |
...
| `references/droit-de-la-consommation.md` | **PARTIEL** |
...
|---|---|
| `SKILL.md` | **RÉDIGÉ** |
| `data/parametres.json` | **233 vérifiée(s)**, 10 à vérifier |
...
| `references/copropriete.md` | **RÉDIGÉ** |
| `references/depot-de-garantie.md` | **RÉDIGÉ** |
| `references/impayes-et-expulsion.md` | **PARTIEL** |
...
|---|---|
| `SKILL.md` | **RÉDIGÉ** |
| `data/parametres.json` | **72 vérifiée(s)**, 0 à vérifier |
| `references/conges-et-absences.md` | **RÉDIGÉ** |
