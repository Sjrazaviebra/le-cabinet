...
**1832 valeurs vérifiées et datées**, 139 encore ouvertes. **9 rôles.**
...
|---|---|
| `SKILL.md` | **RÉDIGÉ** |
| `data/parametres.json` | **186 vérifiée(s)**, 18 à vérifier |
