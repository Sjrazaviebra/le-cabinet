...
**58 valeurs vérifiées et datées**, 9 encore ouvertes. **7 rôles.**
...
| `references/declaration-annuelle.md` | À ÉCRIRE |
...
|---|---|
| `SKILL.md` | **RÉDIGÉ** |
| `data/parametres.json` | **9 vérifiée(s)**, 4 à vérifier |
