...
**1409 valeurs vérifiées et datées**, 100 encore ouvertes. **7 rôles.**
...
|---|---|
| `SKILL.md` | **RÉDIGÉ** |
| `data/parametres.json` | **285 vérifiée(s)**, 16 à vérifier |
